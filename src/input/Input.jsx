...
export default class Input extends Component {
    ...
    renderLabeledInput(children) {
        ...
        if (addonBefore || addonAfter) {
            return (
                <span className={`${props.prefixCls}-group-wrapper`} style={props.style}>
    ...
    renderLabeledIcon(children) {
        ...
        return (
            <span className={classNames(props.className, `${props.prefixCls}-affix-wrapper`)} style={props.style}>
                {prefix}
